...
def _industry_body(first: str, vertical: dict) -> str:
    ...
    if vertical["key"] == "roofing":
        return (
            ...
            "per month now.\n\n"
            "We guarantee meetings, or we keep working until you hit the number. I've got an extra pair "
    ...
    return (
        ...
        "We guarantee meetings, or we keep working until you hit the number. "
        "I can send you a pair of AirPods just for chatting 15 minutes to see if this makes sense.\n\n"
        "Worth a look?\n\n"
        "Josh Osborn"
    )
...
def _general_body(first: str) -> str:
    return (
        ...
        "We guarantee meetings, or we keep working until you hit the number. I can send a Loom "
        "or a pair of AirPods just for chatting 15 minutes to see if this makes sense.\n\n"
        "Worth a look?\n\n"
        "Josh Osborn"
    )
